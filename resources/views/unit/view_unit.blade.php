...
<div class="panel panel-default">
    <div class="panel-heading"> View Unit<a href="create_unit"><span style="float: right"><i class="glyphicon glyphicon-plus-sign"></i> Create Unit</span></a></div>
<div class="panel-body">
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                <th>ID</th> <th>Unit Name</th><th>Unit Code</th><th>Options</th>
            </tr>
        </thead>
        <tbody>
              <?php
