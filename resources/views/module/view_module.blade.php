...
<div class="panel panel-default">
    <div class="panel-heading"> View Module List<a href="create_module"><span style="float: right"><i class="glyphicon glyphicon-plus-sign"></i> Create Module</span></a></div>
<div class="panel-body">
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                <th>Module Name</th><th>Project Name</th>  <th>Start Date</th> <th>Due Date</th><th>Total Task</th><th>Completed Task</th><th>Incompleted Task</th><th style="width: 130px">Status</th> <th style="width: 130px">% Done</th><th>Description</th><th>Options</th>
            </tr>
        </thead>
        <tbody>
              <?php
          ...
          $token=csrf_token(); 
            ...
            <tr>
             ...
             <td> {{$rows->date=date("d M Y",strtotime($rows->due_date))}}</td>  
                   ...
                   <td>{{$rows->completed_task}}</td>
                             
                               <td>{{$rows->task_name-$rows->completed_task}}</td>
                              <td>
                                       <?php
        ...
        <div class='progress-bar progress-bar-striped progress-bar-info  active' role='progressbar' aria-valuenow='40' aria-valuemin='0' aria-valuemax='100' style='width:100%'>
          Closed
                 ...
                 <td>
                       ...
                       <?php
                                       $a = @(($rows->completed_task*100)/$rows->task_name); 
                                  if(false === $a) {
                                     $a = 0;
                                     }
                           /*   echo "<div class='progress'>
